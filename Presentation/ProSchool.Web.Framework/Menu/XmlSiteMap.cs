...
namespace ProSchool.Web.Framework.Menu
{
    public class XmlSiteMap
    {
        ...
        private static void PopulateNode(SiteMapNode siteMapNode, XmlNode xmlNode)
        {
            ...
            siteMapNode.Title = GetStringValueFromAttribute(xmlNode, "Title");  //localizationService.GetResource(nopResource);
            ...
            if (!string.IsNullOrEmpty(permissionNames))
            {
                ...
                siteMapNode.Visible = permissionNames.Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries)
                    .Any(a => System.Web.HttpContext.Current.User.IsInRole(a));
